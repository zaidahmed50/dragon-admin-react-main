...
// Column reference shown to the user
const COLUMN_REFERENCE = [
    { col: "A", label: "Employee Code" },
    { col: "B", label: "Joining Date (d/M/yyyy)" },
    { col: "C", label: "Employee Name" },
    { col: "D", label: "CNIC# (with or without dashes)" },
    { col: "E", label: "Mobile 1" },
    { col: "F", label: "Mobile 2" },
    { col: "G", label: "Mobile 3" },
    { col: "H", label: "Qualifications" },
    { col: "I", label: "Division (COR / ODU)" },
    { col: "J", label: "Department" },
    { col: "K", label: "Designation" },
    { col: "L", label: "Deployment Location (Office Name)" },
    { col: "M", label: "Father Name (also used as Emergency Contact Name)" },
    { col: "N", label: "DOB (d-M-yyyy)" },
    { col: "O", label: "Email" },
    { col: "P", label: "Emergency Contact No" },
    { col: "Q", label: "Blood Group" },
    { col: "R", label: "Address" },
];

const ImportEmployeeDialog = ({ open, onClose, onImportSuccess }) => {
    ...
    const handleImport = async () => {
        ...
        setResult(null);
        try {
            const response = await employeeService.importEmployee(file);
        ...
        >
            ...
            <DialogContent dividers>
                ...
                <Box sx={{ mb: 2 }}>
                    ...
                    {showColumns && (
                        <Paper variant="outlined" sx={{ mt: 1, p: 1.5, maxHeight: 200, overflowY: "auto" }}>
