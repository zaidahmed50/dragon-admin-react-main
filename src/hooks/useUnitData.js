...
export const useUnitData = () => {
    ...
    const fetchUnits = React.useCallback(async (query, page) => {
        setLoading(true);
        setError(null);
        try {
            ...
            if (query) {
                ...
                data = data.filter(item => 
                    ...
                    (item.shortName && item.shortName.toLowerCase().includes(lowerQuery))
                );
            }
    ...
    }, [pageSize, currentPage, fetchUnits, searchQuery]);
